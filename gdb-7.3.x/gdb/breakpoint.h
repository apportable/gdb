...
struct breakpoint
  {
    ...
    /* If non-zero the objfile(s) for this breakpoint are finalized.
       No other objfiles need to be looked at when resetting this
       breakpoint.
       NOTE: This currently only applies to main in symfile_objfile.  */
    int objfiles_final;
  };
