...
/* Ideally, all we need is "$pdir:$sdir".
   Alas $pdir doesn't currently work in gdbserver. :-(  */
#ifdef GDBSERVER
#if __LP64__
#define LIBTHREAD_DB_SEARCH_PATH "/usr/grte/v1/lib64:/usr/grte/v2/lib64:$sdir"
#else
#define LIBTHREAD_DB_SEARCH_PATH "/usr/grte/v1/lib:/usr/grte/v2/lib:$sdir"
#endif
#else
#define LIBTHREAD_DB_SEARCH_PATH "$pdir:$sdir"
#endif
#endif
#endif
